...
#define OQS_COMPILE_BUILD_TARGET "x86_64-Linux-5.15.150.1-microsoft-standard-WSL2+"
...
///// HXW
/* #undef OQS_ENABLE_KEM_CTRUPRIME */
/* #undef OQS_ENABLE_KEM_ctruprime_653 */

#define OQS_ENABLE_KEM_FPTRU 1
#define OQS_ENABLE_KEM_fptru_653 1
#define OQS_ENABLE_KEM_fptru_761 1
#define OQS_ENABLE_KEM_fptru_1277 1
