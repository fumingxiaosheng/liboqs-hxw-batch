...
/* ------------- pack compressed ------------- */
#define poly_compress_4 OSKR_NAMESPACE(poly_compress_4)
void poly_compress_4(uint8_t r[OSKR_POLYCOMPRESSEDBYTES_CV], poly *a);
#define poly_decompress_4 OSKR_NAMESPACE(poly_decompress_4)
void poly_decompress_4(poly *r, const uint8_t a[OSKR_POLYCOMPRESSEDBYTES_CV]);

#define poly_compress_11 OSKR_NAMESPACE(poly_compress_11)
void poly_compress_11(uint8_t r[OSKR_POLYCOMPRESSEDBYTES_CU], poly *a);
#define poly_decompress_11 OSKR_NAMESPACE(poly_decompress_11)
